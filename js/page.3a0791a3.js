parcelRequire = function(e, r, t, n) {
    ...
    "XR92": [function(require, module, exports) {
        ...
        function(t) {
            var e, n = function() {
                ...
                function I(t) {
                    return "children" in t ? l.call(t.children) : r.map(t.childNodes,
                    function(t) {
                ...
                O.fragment = function(t, n, i) {
                    ...
                    o || (t.replace && (t = t.replace(g, "<$1></$2>")), n === e && (n = m.test(t) && RegExp.$1), n in T || (n = "*"), (s = T[n]).innerHTML = "" + t, o = r.each(l.call(s.childNodes),
                    function() {
                        s.removeChild(this)
                    })),
                    R(i) && (a = r(o), r.each(i,
                ...
                O.init = function(t, n) {
                    var i, o;
                    if (!t) return O.Z();
                    if ("string" == typeof t) if ("<" == (t = t.trim())[0] && m.test(t)) i = O.fragment(t, RegExp.$1, n),
                    t = null;
                    else {
                        ...
                        t = null;
                        else if (m.test(t)) i = O.fragment(t.trim(), RegExp.$1, n),
                        t = null;
                        else {
                            if (n !== e) return r(n).find(t);
                            i = O.qsa(f, t)
                ...
                r.fn = {
                    ...
                    filter: function(t) {
                        return $(t) ? this.not(this.not(t)) : r(c.call(this,
                        function(e) {
                    ...
                    parents: function(t) {
                        ...
                        function(t) {
                            if ((t = t.parentNode) && !k(t) && e.indexOf(t) < 0) return e.push(t),
                            t
                        });
                        return _(e, t)
                    },
                    ...
                    show: function() {
                        return this.each(function() {
                            ...
                            "none" == getComputedStyle(this, "").getPropertyValue("display") && (this.style.display = (t = this.nodeName, h[t] || (e = f.createElement(t), f.body.appendChild(e), n = getComputedStyle(e, "").getPropertyValue("display"), e.parentNode.removeChild(e), "none" == n && (n = "block"), h[t] = n), h[t]))
                        })
                    },
                    ...
                    toggleClass: function(t, n) {
                        return t ? this.each(function(i) {
                            var o = r(this);
                            B(this, t, i, X(this)).split(/\s+/g).forEach(function(t) { (n === e ? !o.hasClass(t) : n) ? o.addClass(t) : o.removeClass(t)
                            })
                        }) : this
                    },
                ...
                ["width", "height"].forEach(function(t) {
                    ...
                    r.fn[t] = function(i) {
                        var o, a = this[0];
                        return i === e ? F(a) ? a["inner" + n] : k(a) ? a.documentElement["scroll" + n] : (o = this.offset()) && o[t] : this.each(function(e) { (a = r(this)).css(t, B(this, i, e, a[t]()))
                        })
                    }
                }),
            ...
            function(e) {
                ...
                function T(t, r) {
                    return ! r && t.isDefaultPrevented || (r || (r = t), e.each(j,
                    function(e, n) {
                        var i = r[e];
                        t[e] = function() {
                            return this[n] = x,
                        ...
                        t[n] = b
                    }), t.timeStamp || (t.timeStamp = Date.now()), (r.defaultPrevented !== n ? r.defaultPrevented: "returnValue" in r ? !1 === r.returnValue: r.getPreventDefault && r.getPreventDefault()) && (t.isDefaultPrevented = x)),
                    t
                }
                function w(t) {
                    var e, r = {
                ...
                e.fn.triggerHandler = function(t, n) {
                    var r, i;
                    return this.each(function(o, s) { (r = w(a(t) ? e.Event(t) : t))._args = n,
                        r.target = s,
                        e.each(p(s, t.type || t),
                        function(t, e) {
            ...
            function(e) {
                ...
                e.ajax = function(i) {
                    ...
                    b.crossDomain || ((a = o.createElement("a")).href = b.url, a.href = a.href, b.crossDomain = h.protocol + "//" + h.host != a.protocol + "//" + a.host),
                    ...
                    function(t) {
                        ...
                        !t.data || t.type && "GET" != t.type.toUpperCase() && "jsonp" != t.dataType || (t.url = x(t.url, t.data), t.data = void 0)
                    } (b);
                    var j = b.dataType,
                    T = /\?.+=\?/.test(b.url);
                    if (T && (j = "jsonp"), !1 !== b.cache && (i && !0 === i.cache || "script" != j && "jsonp" != j) || (b.url = x(b.url, "_=" + Date.now())), "jsonp" == j) return T || (b.url = x(b.url, b.jsonp ? b.jsonp + "=?": !1 === b.jsonp ? "": "callback=?")),
                    e.ajaxJSONP(b, E);
                    var w, S = b.accepts[j],
                    C = {},
                    N = function(t, e) {
                            ...
                            if (P.status >= 200 && P.status < 300 || 304 == P.status || 0 == P.status && "file:" == O) {
                                if (j = j || ((r = b.mimeType || P.getResponseHeader("content-type")) && (r = r.split(";", 2)[0]), r && (r == l ? "html": r == c ? "json": s.test(r) ? "script": u.test(r) && "xml") || "text"), "arraybuffer" == P.responseType || "blob" == P.responseType) t = P.response;
                                    ...
                                    try {
                                        ...
                                        "script" == j ? (0, eval)(t) : "xml" == j ? t = P.responseXML: "json" == j && (t = f.test(t) ? null: e.parseJSON(t))
                                    } catch(i) {
                                        n = i
                                    }
                ...
                e.fn.load = function(t, n, r) {
                    ...
                    u = b(t, n, r),
                    c = u.success;
                    return s.length > 1 && (u.url = s[0], i = s[1]),
    ...
    "Bb20": [function(require, module, exports) {
        ...
        var t = require("zepto").$;
        function e() {
            var e = ["希望能成为有趣的人", "给时光以生命<br>给岁月以文明", "你好，请多指教", "当你在凝视着代码的时候<br>代码也正在凝视着你", "要相信，梦里能到达的地方<br>总有一天，脚步也能到达!", "熬过最苦的日子<br>做最酷的自己。", "平凡的日常正奇迹的发生着", "永远都不要放弃自己<br>勇往直前，直至成功！", "人因为梦想而伟大<br> ... 早日达到自己的目标。", "さあ、ゲームを始めよう", "就算被打得遍体鳞伤<br>内心也不会简单屈服。", "敬畏之心！", "赞美之心！", "我怎么那么神奇！", "欢迎大家光临星象馆<br>满天的星星等候着大家的到来", "生活原本沉闷<br>但跑起来就有风。"],
            i = o(0, e.length - 1);
            t("#slogan").html(e[i])
        }
        function o(t, e) {
        ...
        t(function() {
            ...
            function w() {
                u(),
                ++c > 150 && c % 8 == 0 && (a.fillStyle = "rgba(0,0,0,.04)", a.fillRect( - 3 * n, -3 * n, 6 * n, 6 * n)),
                f(.025)
            }
            function f(t) {
            ...
            a.fillRect(0, 0, t, e),
            a.lineCap = "round";
            for (var m, s, g, b, v = 2e4; v--;) m = void 0,
            s = void 0,
            g = void 0,
            b = void 0,
            d.push({
